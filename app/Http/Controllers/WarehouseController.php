...
class WarehouseController extends Controller
{
    ...
    public function orderBy($column, $direction): JsonResponse
    {
        ...
        $categories = $this->warehouseService->getWarehousesOrderedBy($column, $direction);
    ...
    {
        $category = $this->warehouseService->updateWarehouse($id, $request->all());

        return response()->json([
            'message' => 'Warehouse updated successfully!',
            'warehouse' => WarehouseResource::make($category),
        ], 200);
    }
