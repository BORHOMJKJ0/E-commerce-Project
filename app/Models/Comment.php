 ...
 *     @OA\Property(property="image", type="string", example="http://example.com/image.jpg", nullable=true, description="the image URL of an optional image. Must provide either 'text' or 'title', or both."),
 * )
 */
